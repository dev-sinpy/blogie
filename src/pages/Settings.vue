      ...
      <div>
        <q-splitter v-model="splitterModel">
          <template v-slot:before>
            <q-tabs v-model="tab" vertical class="text-accent">
          ...
          <template v-slot:after>
            ...
            >
              <q-tab-panel name="account">
                <div class="text-h5 text-weight-medium text-black q-mb-md">
                  Your Account
                </div>
                <div>
                ...
                <div>
                  <div class="q-mt-md text-weight-medium text-negative">
                    Delete account
                  </div>
                  <q-btn
                    class="q-ma-md"
                  ...
                  <q-dialog v-model="deleteUser">
                    <q-card class="bg-black">
                      ...
                      <q-card-section>
                        <div
                          class="q-mb-md text-weight-medium text-negative text-center"
                        >
                          Delete your account
                        </div>
                      </q-card-section>
...
export default {
  ...
  methods: {
    ...
    submitInterests: async function () {
      ...
      await axios.post(
        `https://blogie.now.sh/api/updateuser/?email=${email}&tags=${tags}`
      );
