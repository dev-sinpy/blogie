            ...
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        ...
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Discover the best articles from the Internet</h1>
                        <div class="hero-paragraph is-revealing text-body2 text-dark">
